Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/2eaaa5cffea781b48a366a5e2bb678eb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = lerp(poiLight.directColor, min(lerp(poiLight.indirectColor * float4(0.04900809,0.02021784,0.01689721,1), float4(0.04900809,0.02021784,0.01689721,1), (1.0 /*_LightingIgnoreAmbientColor*/)) * poiLight.occlusion + (sss * poiLight.directColor), poiLight.directColor), (1.0 /*_ShadowStrength*/));
				#endif
				#endif
				#ifdef POI_PASS_ADD
