Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/2f7284ec3dba06e46ba198f4e0a223d4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float MainColorFeatherStep = (0.464 /*_BaseColor_Step*/) - (0.354 /*_BaseShade_Feather*/);
				float firstColorFeatherStep = (0.459 /*_ShadeColor_Step*/) - (0.0001 /*_1st2nd_Shades_Feather*/);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0.280335,0.280335,0.280335,1).rgb; //* lighColor
				secondShadeMap.rgb *= float4(0.04539379,0.04539379,0.04539379,1).rgb; //* LightColor;
				float shadowMask = 1;
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.464 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
				float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / ((0.459 /*_ShadeColor_Step*/) - firstColorFeatherStep) * (shadowMask));
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (3.09 /*_EmissionStrength*/);
			...
			{
				float smoothness = (0.479 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.743 /*_MochieMetallicMultiplier*/);
