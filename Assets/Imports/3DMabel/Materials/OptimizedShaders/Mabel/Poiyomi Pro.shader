Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/b25110e1430ff3f4a9d95708e32fb700"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float MainColorFeatherStep = (1.0 /*_BaseColor_Step*/) - (0.081 /*_BaseShade_Feather*/);
				float firstColorFeatherStep = (0.508 /*_ShadeColor_Step*/) - (1.0 /*_1st2nd_Shades_Feather*/);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0.2319224,0.2319224,0.2319224,1).rgb; //* lighColor
				secondShadeMap.rgb *= float4(0.04900809,0.04900809,0.04900809,1).rgb; //* LightColor;
				float shadowMask = 1;
				...
				float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / ((0.508 /*_ShadeColor_Step*/) - firstColorFeatherStep) * (shadowMask));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.169 /*_MatcapAddToLight*/), (0.163 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (1.0 /*_MatcapMixed*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.533 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			#ifdef POSTPROCESS
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col *= float4(1,1,1,1);
				col *= float4(1,1,1,1);
				col = GetSaturation(col, (1.5 /*_PPSaturation*/));
				col = lerp(col, GetHDR(col), (0.57 /*_PPHDR*/));
				col = GetContrast(col, (1.0 /*_PPContrast*/));
				col *= (2.0 /*_PPBrightness*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.27 /*_BumpScale*/));
				#else
				...
				poiLight.directColor = max(poiLight.directColor + (1.0 /*_PPLightingAddition*/), 0);
				poiLight.indirectColor = max(poiLight.indirectColor * (1.0 /*_PPLightingMultiplier*/), 0);
				poiLight.indirectColor = max(poiLight.indirectColor + (1.0 /*_PPLightingAddition*/), 0);
				#endif
				#endif
				#ifdef POI_PASS_ADD
