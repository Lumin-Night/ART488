Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/a7c4a67a62df16d49a6fec946919935f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float MainColorFeatherStep = (0.891 /*_BaseColor_Step*/) - (0.323 /*_BaseShade_Feather*/);
				float firstColorFeatherStep = (0.422 /*_ShadeColor_Step*/) - (0.343 /*_1st2nd_Shades_Feather*/);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0.250646,0.250646,0.250646,1).rgb; //* lighColor
				secondShadeMap.rgb *= float4(0.02207365,0.02207365,0.02207365,1).rgb; //* LightColor;
				float shadowMask = 1;
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.891 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
				float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / ((0.422 /*_ShadeColor_Step*/) - firstColorFeatherStep) * (shadowMask));
			...
			{
				float smoothness = (0.824 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.505 /*_MochieReflectionStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.directColor = max(poiLight.directColor + (0.5 /*_PPLightingAddition*/), 0);
				poiLight.indirectColor = max(poiLight.indirectColor * (1.0 /*_PPLightingMultiplier*/), 0);
				poiLight.indirectColor = max(poiLight.indirectColor + (0.5 /*_PPLightingAddition*/), 0);
				#endif
				#endif
				#ifdef POI_PASS_ADD
